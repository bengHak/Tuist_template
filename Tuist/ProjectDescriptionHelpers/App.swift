...
public struct AppFactory {
    ...
    public func build(payload: Payload) -> [Target] {
        ...
        let mainTarget = Target(
            ...
            resources: ["\(payload.name)/Resources/**"],
            scripts: [.SwiftLintString],
            dependencies: self.dependency.appDependencies,
            settings: .settings(configurations: [
                .debug(name: "Debug", xcconfig: "../../BuildConfigurations/Debug.xcconfig"),
                .release(name: "Release", xcconfig: "../../BuildConfigurations/Release.xcconfig"),
            ])
        )
